...
export function SuggestionBox({users}:any){
    ...
    console.log(users)
    return(
        <>  <div className="absolute z-10 md:mx-4  w-[100%] rounded-xl h-full flex justify-center backdrop-blur-md overflow-scroll scrollbar-hidden ">
                <div className="w-[95%] md:w-1/2 h-fit   bg-slate-600 p-1 rounded ">
